...
function updateTimer() {
  const targetDate = new Date("august 29, 2026 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543816651602'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543815552294'; // Número para el primer botón
